...
Ext.define('Ext.ux.TreePicker', {
    ...
    createPicker: function() {
        var me = this,
            picker = new Ext.tree.Panel({
                ...
                manageHeight: true,     // Modified by finkle 2014-11-05
                shadow: false,
                rootVisible : false,    // Added by finkle 2014-11-05
                autoScroll: true,       // Added by finkle 2014-11-05
                listeners: {
                    scope: me,
    ...
    setValue: function(value) {
        ...
        /* Added by finkle 2015-01-07 */
        me.inputEl.dom.realValue = me.value;
