...
(function ($) {
    ...
    SM_NOTE = function(paramOption) {
        var userOption = {
            ...
            title: "새 쪽지 도착 알림",
            cls: "toaster",
            iconCls: "toaster-icon-info",
            html: "새 쪽지가 도착했습니다.",
            buttonAlign: "center",
            buttons: [{ 
                text: "쪽지 보기", handler: function(btns) {
                    
                    Ext.getCmp("id_main_menu").smSelect("note");
                            
                    btns.ownerCt.ownerCt.close();
                }
            }]
        };
        ...
        return Ext.create("widget.uxNotification", userOption).show();
    };
