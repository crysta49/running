        ...
        <fieldset>
            ...
            <div>
                <table class="tbl-excel">
                    <tr>
                        <td><input type="checkbox" name="chk" id="title" class="smf-checkbox" value="title" /><label for="title">에러 메시지</label></td>
                        <td><input type="checkbox" name="chk" id="url" class="smf-checkbox" value="url" /><label for="url">에러 URL</label></td>
                        <td><input type="checkbox" name="chk" id="regDt" class="smf-checkbox" value="regDt" /><label for="regDt">발생일</label></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" name="chk" id="solvYn" class="smf-checkbox" value="solvYn" /><label for="solvYn">해결여부</label></td>
                        <td><input type="checkbox" name="chk" id="solvDt" class="smf-checkbox" value="solvDt" /><label for="solvDt">해결일</label></td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    var js_checkDefault = function() {
        ...
        $("#title, #url, #regDt").prop("checked", true);
    };
