...
<script type="text/javascript" src="<c:url value="/resources/spi/highchart/highcharts.js"/>"></script>
<script type="text/javascript">
    ...
    var js_link = function(menuId, param) {
        if (top.Ext.getCmp("id_main_menu"))
            top.Ext.getCmp("id_main_menu").smSelect(menuId, param);
    };
</script>
