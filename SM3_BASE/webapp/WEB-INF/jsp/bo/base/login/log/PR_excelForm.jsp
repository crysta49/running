            ...
            <div>
                <table class="tbl-excel">
                    <tr>
                        ...
                        <td><input type="checkbox" name="chk" id="mgrId" class="smf-checkbox" value="mgrId" /><label for="mgrId">아이디 (ID)</label></td>
                        <td><input type="checkbox" name="chk" id="agencyNm" class="smf-checkbox" value="agencyNm" /><label for="agencyNm">대리인</label></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" name="chk" id="ipAddr" class="smf-checkbox" value="ipAddr" /><label for="ipAddr">접속 IP</label></td>
                        <td><input type="checkbox" name="chk" id="loginDt" class="smf-checkbox" value="loginDt" /><label for="loginDt">접속일</label></td>
                        <td><input type="checkbox" name="chk" id="logOutDt" class="smf-checkbox" value="logOutDt" /><label for="logOutDt">접속해제일</label></td>
                    </tr>
                </table>
            </div>
        </fieldset>
...
<script type="text/javascript">
    ...
    var js_checkDefault = function() {
        ...
        $("#mgrNm, #mgrId, #ipAddr, #loginDt, #logOutDt").prop("checked", true);
    };
