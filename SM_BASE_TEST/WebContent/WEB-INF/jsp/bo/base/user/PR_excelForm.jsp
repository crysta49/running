        ...
        <fieldset>
            ...
            <div>
                <table class="tbl-excel">
                    <tr>
                        <td><input type="checkbox" name="chk" id="userNm" class="smf-checkbox" value="userNm" /><label for="userNm">이름</label></td>
                        <td><input type="checkbox" name="chk" id="userId" class="smf-checkbox" value="userId" /><label for="userId">ID</label></td>
                        <td><input type="checkbox" name="chk" id="typeNm" class="smf-checkbox" value="typeNm" /><label for="typeNm">유형</label></td>
                        <td><input type="checkbox" name="chk" id="userEncTelNum" class="smf-checkbox" value="userEncTelNum" /><label for="userEncTelNum">전화번호</label></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" name="chk" id="userEncMobile" class="smf-checkbox" value="userEncMobile" /><label for="userEncMobile">휴대폰</label></td>
                        <td><input type="checkbox" name="chk" id="userEncEmail" class="smf-checkbox" value="userEncEmail" /><label for="userEncEmail">이메일</label></td>
                        <td><input type="checkbox" name="chk" id="postCd" class="smf-checkbox" value="postCd" /><label for="postCd">주소</label></td>
...
<script type="text/javascript">
    ...
    var js_checkDefault = function() {
        ...
        $("#userNm, #typeNm, #userEncMobile, #userEncEmail, #userEncTelNum, #regDt").prop("checked", true);
    };
