...
<div class="row">
    ...
    <div class="col-xs-8">
        <div id="viewDiv">
            ...
            <table class="tbl-header" style="margin-top: 14px;">
                <tr>
                    <th><span class="title-big">지정 관리자 목록</span></th>
                    <td class="tr">
                        <span class="t3-help smtip" style="padding-left: 13px;">&nbsp;</span>
                        <div class="sr-hidden">
                            <div class="smtip-title">관리자 지정 방법</div>
                            <div class="smtip-text">
                                <div>직원 목록에서 대상직원을 더블클릭하거나, 지정 관리자 목록으로 해당 직원을 끌어다 놓으세요. (Drag &amp; Drop)</div>
                            </div>
                        </div>
                    </td>
                </tr>
...
<script type="text/javascript">
    ...
    var js_gridSaveAction = function(e) {
        ...
        if ( datas.length == 0 ) {
            alert("지정된 관리자가 목록에 없습니다."); return false;
        }
        if ( confirm(datas.length + "명의 직원을 관리자로 지정하시겠습니까?") ) {
            parent.js_setBbsMgrValues(datas, true);
            SM.modalClose();
        }
    };
