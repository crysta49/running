...
import com.srpost.cm.si.bbs.haru.BbsHaruBean;
...
public class BbsExtDao extends EgovAbstractMapper {
    ...
    /** haru가 사용 */
    public void listHaru(List<BbsHaruBean> dataList, BbsConfBean confBean) {
    ...
    private Map<String, Object> getParameterMapHaru(BbsHaruBean bean, BbsConfBean confBean) {
    ...
    public Map<String, Object> viewHaru(BbsHaruBean dataBean, BbsConfBean confBean) {
    ...
    public void insertActionHaru(BbsHaruBean bean, BbsConfBean confBean) {
        ...
        update("_bbsExt.insert", getParameterMapHaru(bean, confBean));
    }
    
    public void updateActionHaru(BbsHaruBean bean, BbsConfBean confBean) {
